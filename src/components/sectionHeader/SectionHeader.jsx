...
const SectionHeader = ({cta,  link, linkContent, title, description, buttonStyles }) => {
  return (
    <div className='text-white mt-75'>
      {!cta && <img src={stars} alt="stars" className='relative left-[-20px] Mxxl:w-[54px] Mxxl:h-24 Mmd:w-[45px] Mmd:h-[20px]' />}
      <div className='mt-10'>
