...
const TestimonialsList = ({ testimonialsContainer, content }) => {
    return (
        <div ref={testimonialsContainer}
            ...
            {content.map(({ id, rating, title, desc, userName, userAddress, userImage }) => (
                <div key={id} className='xxl:p-50 xl:p-40 md:p-20 p-24 flex flex-col xxl:gap-40 xl:gap-30 gap-24 rounded-10 border-1 border-grey-15 bg-grey-08 text-white'>
