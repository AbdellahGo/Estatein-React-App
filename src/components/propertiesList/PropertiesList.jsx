...
const PropertiesList = ({ content, propertiesContainer }) => {
  ...
  return (
    <div ref={propertiesContainer}
      ...
      {content.map(({ listing_id, num_bedrooms, num_bathrooms, short_description, property_type, title, price, original_image }) => (
        <div key={listing_id} className='xxl:p-40 xl:p-30 md:p-20 p-24 flex flex-col  xxl:gap-30 md:gap-20 gap-16 rounded-12 border-1 border-grey-15'>
