  ...
  return (
    <div className={`cta xxl:mt-[96px] xl:mt-[72px] mt-80 text-white border-y-1 border-grey-15 xxl:py-[100px] md:py-[60px] py-[50px] relative overflow-hidden`}>
      ...
      <div className={`${padding_x} ${container}`}>
        <SectionHeader cta noStars link='/properties' linkContent='Explore Properties' title={title} description={description} buttonStyles={`xxl:w-[24%] xl:w-[27%] lg:w-[56%] md:w-[105%] text-center w-[80%] bg-purple-60`} />
      </div>
    </div>
  )
}
