...
const OurJourney = () => {
    ...
    return (
        <div className={`our-journey xxl:mt-[100px] lg:mt-[70px] mt-50 ${container} ${padding_x} text-white`}>
            <div className='lg:grid lg:grid-cols-2 Mlg:flex Mlg:flex-col-reverse items-center  xxl:gap-80 lg:gap-60 gap-20'>
                <div className='flex flex-col xxl:gap-80 lg:gap-50 gap-40'>
